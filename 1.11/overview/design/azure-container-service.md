...
For a more comprehensive architecturel description of DC/OS, see [The Architecture of DC/OS](/docs/1.11/overview/architecture/); for a more complete discussion of components, see [An Introduction to DC/OS Components](/docs/1.11/overview/architecture/components/).
...
![Azure Container Service archictecture using DC/OS.](/docs/1.11/img/dcos-acs.png)
