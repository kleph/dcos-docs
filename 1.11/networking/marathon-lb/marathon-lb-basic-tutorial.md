...
### Prerequisites
- [A DC/OS cluster](/docs/1.11/installing/) with at least one [private](/docs/1.11/overview/concepts/#private) agent and one [public](/docs/1.11/overview/concepts/#public-agent-node) agent.
- [DC/OS CLI](/docs/1.11/cli/install/) is installed.
...
1.  Copy `dcos-website/dcos-website.json` from the [dcos-website](https://github.com/dcos/dcos-website/blob/develop/dcos-website.json) GitHub repository.
    ...
    1.  Go to the [mesosphere/dcos-website](https://hub.docker.com/r/mesosphere/dcos-website/tags/) Docker Hub repository and copy the latest image tag.
        ...
        ![Mesosphere Docker Hub](/docs/1.11/img/dockerhub.png)
        
    1.  Replace `<image-tag>` in the `docker:image` field with the tag. 
        
    1.  Locate and take note of [your public agent node](/docs/1.11/administering-clusters/locate-public-agent/) IP address.
...
1.  Go to the **Services** tab of the DC/OS web interface to verify that your application is healthy.
    ...
    ![Healthy Service](/docs/1.11/img/healthy-dcos-website.png)
