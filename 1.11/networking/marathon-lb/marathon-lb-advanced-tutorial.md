...
*   DC/OS installed by using the AWS [cloud templates](/docs/1.11/installing/cloud/aws/) with at least three [private](/docs/1.11/overview/concepts/#private) agent and one [public](/docs/1.11/overview/concepts/#public-agent-node) agent.
*   DC/OS CLI [installed][2].
*   Marathon-LB [installed](/docs/1.11/networking/marathon-lb/usage/).

## Deploy an external load balancer with Marathon-LB

1.  Verify that Marathon-LB is working. Find the public IP for your [public node](/docs/1.11/administering-clusters/locate-public-agent/) and navigate to `<public-agent-IP>:9090/haproxy?stats`. You will see a statistics report page like this:

    ![lb2](/docs/1.11/img/lb2.jpg)
...
1.  [Install](/docs/1.11/networking/marathon-lb/usage/) the internal Marathon-LB instance with the custom options specified.
...
1.  Find your [public agent IP](/docs/1.11/administering-clusters/locate-public-agent/).
...
1.  Modify the external nginx app (`nginx-external.json`) to point to your public agent DNS name. You can modify your app by using the DC/OS CLI or GUI.
    ...
    **DC/OS GUI**
    ...
    1.  Enter `HAPROXY_0_VHOST` for **KEY** and specify your public agent DNS name for **VALUE**.
        ...
        ![Update app](/docs/1.11/img/nginx-external-gui.png)
...
1.  Navigate to the public agent in your browser and you should see the following:
    ...
    ![lb6](/docs/1.11/img/lb6.jpg)

 [1]: /docs/1.11/installing/
 [2]: /docs/1.11/cli/install/
 [3]: /docs/1.11/administering-clusters/locate-public-agent/
 [4]: /docs/1.11/administering-clusters/sshcluster/
