...
- Marathon provides a `health` member of the task resource via the [REST API](/docs/1.11/deploying-services/marathon-api/) that you can add to your service definition.
...
![GUI health check](/docs/1.11/img/health-check-gui.png)
