...
1.  Monitor Exhibitor and wait for it to converge at `http://<master-ip>:8181/exhibitor/v1/ui/index.html`.
    ...
    __Tip:__ If you encounter errors such as `Time is marked as bad`, `adjtimex`, or `Time not in sync` in journald, verify that Network Time Protocol (NTP) is enabled on all nodes. For more information, see the [system requirements](/docs/1.11/installing/custom/system-requirements/#port-and-protocol).
...
[1]: /docs/1.11/installing/custom/configuration/configuration-parameters/
[2]: /docs/1.11/cli/install/
[4]: https://downloads.dcos.io/dcos/stable/dcos_generate_config.sh
[6]: /docs/1.11/overview/concepts/#public-agent-node
[7]: /docs/1.11/overview/concepts/#private
[8]: /docs/1.11/installing/custom/uninstall/
