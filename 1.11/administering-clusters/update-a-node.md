...
*   [SSH installed and configured](/docs/1.11/administering-clusters/sshcluster/). This is required when removing nodes by manually killing agents.
*   Access to the [Admin Router permissions](/docs/1.11/overview/architecture/components/#admin-router).
...
1.  [SSH to the agent nodes](/docs/1.11/administering-clusters/sshcluster/).
1.  Stop the agents.
