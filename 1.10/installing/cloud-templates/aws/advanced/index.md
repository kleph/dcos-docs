...
* A node that meets the bootstrap node [prerequisites](/docs/1.10/installing/advanced-installer/system-requirements/).
...
1.  Create a configuration file in the `genconf` directory and save as `config.yaml`. This configuration file specifies your AWS credentials and the S3 location to store the generated artifacts. These are the required parameters:
    ...
    For parameters descriptions and configuration examples, see the [documentation](/docs/1.10/installing/config/reference/).
