---
post_title: Prerequisites for Installing DC/OS using the CLI Installer
...
Docker must be installed on the bootstrap node. The supported versions of Docker are:
...
[1]: /docs/1.10/installing/cli-installer/
[2]: /docs/1.10/installing/cli-installer/prerequisites/install-docker-centos/
[3]: https://downloads.dcos.io/dcos/stable/dcos_generate_config.sh
[4]: /docs/1.10/installing/gui-installer/
