...
For more information, see the [multi-zone](/docs/1.10/installing/high-availability/multi-zone/) and [multi-region](/docs/1.10/installing/high-availability/multi-region/) documentation.
