...
First, you or the data center operator needs to [configure the virtual networks](/docs/1.9/networking/virtual-networks/).
...
Learn more about ports and networking in [Marathon](/docs/1.9/deploying-services/service-ports/).
